...
urlpatterns = [
    ...
    path('<int:user_id>/posts',views.ProfilePostsView.as_view(),name='user-posts'),

    path('<int:pk>/follow/',views.FollowView.as_view({'post':'follow'}),name='follow'),    # pk is pk of user profile to follow
    ...
    path('<int:pk>/followings/',views.FollowView.as_view({'get':'followings'}),name='user-followings'),
    path('friends/',views.FollowView.as_view({'get':'friends'}),name='friends'),           # get current user friends
    path('<int:user_id>/mutual-friends/',views.FollowView.as_view({'get':'friends'}),name='friends'),   # get current user friends
