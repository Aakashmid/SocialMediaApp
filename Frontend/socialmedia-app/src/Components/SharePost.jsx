        ...
        <div className="share-container custom-shodow-b p-4 rounded-xl">
            <form onSubmit={handleSubmit}>
                <div className="share-top flex space-x-2">
                    <img src="src/assets/person/1.jpeg" alt="" className="w-12 h-12 rounded-[50%] object-cover" />
                    <input type="text" name="text" id="text" value={formData.text} onChange={handleTextChange} className="focus:outline-none text-[15px] p-1 w-10/12" placeholder="What is in your mind Aakash ?" />
                </div>
