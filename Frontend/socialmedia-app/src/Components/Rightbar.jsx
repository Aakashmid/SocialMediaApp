      ...
      <li className="my-1 p-1">
        <Link to={'/profile'} className="flex  space-x-4 items-center">
          <div className="relative">
            ...
            <img src="src/assets/person/1.jpeg" className="w-9 h-9 object-cover rounded-[50%]" alt="" />
          </div>
  ...
  return (
    <div className="rightbar-wrapper py-5 pr-5">
      <div className="info flex items-center space-x-4">
        <img src="src/assets/gift.png" className="w-10 h-auto " alt="" /> <h2 className=""><strong>Aakash</strong> and <strong>3 other friends </strong> has birthday today</h2>
      </div>
      <div className="my-5"><img src="src/assets/group.png" className="w-full object-cover rounded-lg h-auto" alt="" /></div>
